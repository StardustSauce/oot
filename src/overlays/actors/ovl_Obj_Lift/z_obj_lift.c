...
void ObjLift_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->unk168.x = Rand_ZeroOne() * (0x10000 - 0.5f);
    this->unk168.y = Rand_ZeroOne() * (0x10000 - 0.5f);
    this->unk168.z = Rand_ZeroOne() * (0x10000 - 0.5f);
    func_80B9651C(this);
